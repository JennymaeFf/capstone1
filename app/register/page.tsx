...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#DDF8B1] font-sans flex flex-col">
      ...
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FFF6DE] px-6 md:px-20 py-4 flex justify-between items-center border-b border-[#ffe082] shadow-sm">
        <div className="flex items-center gap-3">
          <Image src="/logo.png" alt="Logo" width={50} height={50} className="object-contain" />
          <div>
            <h1 className="text-[#5d4037] text-lg md:text-xl font-bold tracking-wide leading-tight">INDABEST CRAVE CORNER</h1>
            <p className="text-[#a1887f] text-xs">We got your cravings covered!</p>
          </div>
        </div>
        <ul className="hidden md:flex gap-8 text-[#5d4037] text-sm font-semibold items-center">
          <li><Link href="/" className="hover:text-[#4caf50] transition">HOME</Link></li>
          <li><Link href="/menu" className="hover:text-[#4caf50] transition">MENU</Link></li>
          <li><Link href="/story" className="hover:text-[#4caf50] transition">OUR STORY</Link></li>
          <li><Link href="/contact" className="hover:text-[#4caf50] transition">CONTACT US</Link></li>
        </ul>
      </nav>
